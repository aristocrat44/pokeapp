...
export default class Genderless extends Component {
    ...
    const res = await axios.get('https://pokeapi.co/api/v2/gender/genderless');
    ...
    notify = () => toast('Filter - Gender: Genderless applied !',{type:'dark'});
