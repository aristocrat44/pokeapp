...
export default class MaleSpecies extends Component {
    ...
    const res = await axios.get('https://pokeapi.co/api/v2/gender/male');
    ...
    notify = () => toast('Filter - Gender: MALE applied !',{type:'dark'});
