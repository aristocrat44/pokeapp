...
export default class Cave extends Component {
    ...
    const res = await axios.get('https://pokeapi.co/api/v2/pokemon-habitat/1');
    this.setState({pokemon: res.data.pokemon_species});  
       this.notify();
    }

    notify = () => toast('Filter - Region: CAVE applied !',{type:'dark'});
