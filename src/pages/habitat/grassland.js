...
export default class Grassland extends Component {
    ...
    const res = await axios.get('https://pokeapi.co/api/v2/pokemon-habitat/3');
    this.setState({pokemon: res.data.pokemon_species});  
       this.notify();
    }

    notify = () => toast('Filter - Region: GRASSLAND applied !',{type:'dark'});
