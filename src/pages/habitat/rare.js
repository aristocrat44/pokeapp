...
export default class Rare extends Component {
    ...
    const res = await axios.get('https://pokeapi.co/api/v2/pokemon-habitat/5');
    this.setState({pokemon: res.data.pokemon_species});
       this.notify();
    }

    notify = () => toast('Filter - Region: RARE applied !',{type:'dark'});
