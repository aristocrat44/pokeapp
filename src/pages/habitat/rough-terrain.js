...
export default class RoughTerrain extends Component {
    ...
    const res = await axios.get('https://pokeapi.co/api/v2/pokemon-habitat/6');
    this.setState({pokemon: res.data.pokemon_species});
  
       this.notify();
    }

    notify = () => toast('Filter - Region: ROUGH-TERRAIN applied !',{type:'dark'});
