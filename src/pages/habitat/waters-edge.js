...
export default class WatersEdge extends Component {
    ...
    const res = await axios.get('https://pokeapi.co/api/v2/pokemon-habitat/9');
    this.setState({pokemon: res.data.pokemon_species});  
       this.notify();
    }

    notify = () => toast('Filter - Region: WATERS-EDGE applied !',{type:'dark'});
